 ...
 * 
 *  @(#) $Id: resolver.h 1.7 2017/6/1 8:50:23 abe $
 */
...
#define TMO_DNS_UDP_SND		ULONG_C(1*1000)	/* [ms]、DNS サーバへの   UDP 送信タイムアウト	*/
#define TMO_DNS_UDP_RCV		ULONG_C(5*1000)	/* [ms]、DNS サーバからの UDP 受信タイムアウト	*/
