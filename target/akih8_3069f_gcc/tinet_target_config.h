 ...
 * 
 *  @(#) $Id: tinet_target_config.h,v 1.6 2012/07/18 04:17:01 abe Exp abe $
 */
...
#define INTNO_IF_ED		TINTNO_IRQ5		/* IRQ5 */
#define INTATR_IF_ED		(TA_NEGEDGE)		/* 割込み属性	*/
#define INTPRI_IF_ED		(-1)						/* 割込み優先度	*/
